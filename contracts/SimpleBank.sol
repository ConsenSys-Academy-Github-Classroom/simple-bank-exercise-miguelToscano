...
contract SimpleBank {
    ...
    modifier userIsEnrolled() {
      require(enrolled[msg.sender] != false, "User is not enrolled");
      _;
    }

    /// @notice Get balance
    /// @return The balance of the user
    function getBalance() public view userIsEnrolled returns (uint) {
    ...
    function deposit() public userIsEnrolled payable returns (uint) {
    ...
    function withdraw(uint withdrawAmount) public userIsEnrolled payable returns (uint) {
